...
public class MethodExam {
	...
	/*
	 * 입력 : 정수 2개 처리 : 정수 덧셈 반환값 : 처리 결과 정수값 작성자 : @author simple 작성일자 : @since
	 * 2025년 12월 22일
	 */
