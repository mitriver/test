...
public class VandingMachine {
    ...
    public VandingMachine(Coin coin, ProductOutput output, ReturnButton returnButton, DisplayPanel display) {
        this.coin = coin;
        this.output = output;
    ...
    public void selectCoffee(int index) {
        ...
        if (coin.getAmount() >= coffee.getPrice()) {
            ...
            display.showMessage("잔액부족 " + coffee.getPrice() + "원이 필요힙니다.");
        }
    ...
    public static void main(String[] args) {
        ...
        ReturnButton returnButton1 = new ReturnButton(coin, display);

        VandingMachine vm = new VandingMachine(coin, output, returnButton1,display);
